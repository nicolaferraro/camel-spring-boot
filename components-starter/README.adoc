...
| link:https://camel.apache.org/components/latest/vertx-http-component.html[Vert.x HTTP Client] | camel-vertx-http-starter | Preview | 3.5 | Send requests to external HTTP servers using Vert.x

| link:https://camel.apache.org/components/latest/vertx-websocket-component.html[Vert.x WebSocket] | camel-vertx-websocket-starter | Preview | 3.5 | Expose WebSocket endpoints and connect to remote WebSocket servers using Vert.x
